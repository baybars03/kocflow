...
import { ArrowLeft, TrendingUp, Target, ClipboardCheck, MessageCircle, Star, Sparkles, Loader2 } from 'lucide-react';
          ...
          <div className="lg:col-span-2 space-y-8">
            <PlayfulCard className="bg-white">
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="bg-playful-dark text-white px-4 py-1 rounded-full font-black text-sm">
                  Son 5 Deneme
                </div>
              </div>
              <div className="h-80">
          ...
          <div className="space-y-8">
            <PlayfulCard className="bg-white border-b-8 border-playful-dark">
              ...
              <div className="space-y-3">
                ...
                {tasks?.filter(t => !t.done).length === 0 && (
                  <div className="text-center py-6 text-slate-300 font-bold">Tüm görevler tamam! 🎯</div>
                )}
              </div>
            </PlayfulCard>
            <PlayfulCard className="bg-slate-50 border-dashed border-4 border-slate-300">
               ...
               <div className="text-right mt-2">
                 <span className="text-[10px] font-black uppercase text-muted-foreground">Otomatik kaydediliyor</span>
               </div>
            </PlayfulCard>
          </div>
        </div>
